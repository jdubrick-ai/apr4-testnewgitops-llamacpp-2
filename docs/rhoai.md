...
3) Access the `workbench` named `apr4-testnewgitops-llamacpp-2-notebook`.
...
5) In the terminal, run `cd apr4-testnewgitops-llamacpp-2` to navigate to your sample app's directory.
